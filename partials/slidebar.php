...
<div class="content__sidebar">
    ...
    <div class="sidebar__img">
        ...
        <a class="brands__img" <?php echo $each_sb['manuf_name'] ?>>
            <img src="img/categoris/<?php echo $each_sb['photo'] ?>" alt="">
        </a>
        <?php } else { ?>
        <a class="brands__img" <?php echo $each_sb['manuf_name'] ?>>
            <img src="img/categoris/<?php echo $each_sb['photo'] ?>" alt="">
    ...
    <div class="sidebar__img">
        ...
        <a class="brands__img" <?php echo $each_sbt['manuf_name'] ?>>
            <img src="img/categoris/<?php echo $each_sbt['photo'] ?>" alt="">
        </a>
        <?php } else { ?>
        <a class="brands__img" <?php echo $each_sbt['manuf_name'] ?>>
            <img src="img/categoris/<?php echo $each_sbt['photo'] ?>" alt="">
