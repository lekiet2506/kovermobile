...
-- Thời gian đã tạo: Th12 09, 2023 lúc 03:10 PM
...
DROP TABLE IF EXISTS `config_laptop`;
...
DROP TABLE IF EXISTS `config_product_laptop`;
...
(37, 'lekiet', 'lekhalekiet@gmail.com', '0abc54ba5fd89e35d9aedbe466950f54', '0378387649', 1, 1, 'TPHCM', NULL, '2023-12-05 13:09:13', NULL, '2023-12-05 13:09:13'),
(38, 'huyha', 'huyha@gmail.com', '1672b83d581ec6fdc196aba9d6181904', '093785264', 1, 1, 'TPHCM', NULL, '2023-12-08 17:39:12', NULL, '2023-12-08 17:39:12'),
(39, 'namquang', 'namquang@gmail.com', '1435d79ca5082a290bbccfd96cd4e013', '0933333333', 1, 1, 'TPHCM', NULL, '2023-12-09 11:00:05', NULL, '2023-12-09 11:00:05');
...
CREATE TABLE IF NOT EXISTS `order_detail` (
  ...
  `deleted_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`product_id`,`order_id`,`product_lp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
